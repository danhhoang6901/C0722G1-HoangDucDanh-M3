...
<div class="vh-100">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-secondary" style="height: 10%">
        <div class="container-fluid" style="margin-left: 40px">
            <a style="font-weight: bold" class="navbar-brand" href="/facility">List service</a>
    ...
    <div style="height: 70%">
        ...
        <table class="table table-striped table-bordered" style="width: 100%" id="tableFacility">
            <thead>
            <tr>
                <th scope="col">STT</th>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Do you want to delete this service <b
                                            style="color:red;">${facility.getName()}</b> ?
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel
                                        </button>
                                        <a href="/facility?action=delete&id=${facility.getId()}"
