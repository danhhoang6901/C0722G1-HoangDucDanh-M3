        ...
        <form method="post">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>Name:</td>
                        <td><input type="text" name="name" required pattern="\D{5,50}" title="Chưa đúng định dạng"></td>
                    </tr>
                    <tr>
                        <td>Date Of Birth:</td>
                        <td><input type="text" name="birthday" required pattern="\d{4}-\d{2}-\d{2}" title="Phải đúng định dạng yyyy-MM-dd"></td>
                    </tr>
                    <tr>
                        <td>Id Card:</td>
                        <td><input type="text" name="idCard" required pattern="\d{9}" title="Id card phải đúng 9 số"></td>
                    </tr>
                    <tr>
                        <td>Salary:</td>
                    ...
                    <tr>
                        <td>Phone number:</td>
                        <td><input type="text" name="phone" required pattern="\d{10}" title="Số điện phải đúng 10 số"></td>
                    </tr>
                    <tr>
                        <td>Email:</td>
                        <td><input type="text" name="email" required pattern="[A-Za-z0-9]+[A-Za-z0-9]*@[A-Za-z0-9]+([.][A-Za-z0-9]+)" title="Chưa đúng định dạng abcde@gmail.com"></td>
                    </tr>
                    <tr>
                        <td>Address:</td>
