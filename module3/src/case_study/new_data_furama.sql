...
INSERT INTO `data_furama`.`education_degree` (`id`, `name`)
VALUES (1, 'Trung Cấp'),
(2, 'Cao Đẳng'),
(3, 'Đại Học'),
(4, 'Sau Đại Học');
...
INSERT INTO `data_furama`.`division` (`id`, `name`) 
...
-- Thêm thông tin role
INSERT INTO `data_furama`.`role` (`role_id`, `role_name`) 
VALUES ('1', 'Admin'),
('2', 'User');
...
INSERT INTO `data_furama`.`employee` (`id`, `name`, `date_of_birth`, `id_card`, `salary`, `phone_number`, `email`, `address`, `position_id`, `education_degree_id`, `division_id`) 
...
INSERT INTO `data_furama`.`customer_type` (`id`, `name`) 
VALUES (1, 'Diamond'),
(2, 'Platinium'),
(3, 'Gold'),
(4, 'Silver'),
...
INSERT INTO `data_furama`.`customer` (`id`, `name`, `date_of_birth`,`gender`,`id_card`, `phone_number`, `email`, `address`, `customer_type_id`) 
...
INSERT INTO `data_furama`.`facility_type` (`id`, `name`) VALUES 
(1, 'Villa'),
(2, 'House'),
(3, 'Room');

-- Thêm rent_type
INSERT INTO `data_furama`.`rent_type` (`id`, `name`) 
VALUES (1, 'year'),
(2, 'month'),
(3, 'day'),
(4, 'hour');
...
-- Thêm facility
INSERT INTO `data_furama`.`facility` (`id`, `name`, `area`, `cost`, `max_people`, `standard_room`, `description_other_convenience`, `pool_area`, `number_of_floors`, `facility_free`, `rent_type_id`, `facility_type_id`) 
...
-- Thêm contract
INSERT INTO `data_furama`.`contract` (`id`, `start_date`, `end_date`, `deposit`, `employee_id`, `customer_id`, `facility_id`) 
...
INSERT INTO `data_furama`.`attach_facility` (`id`, `name`, `cost`, `unit`, `status`) 
...
INSERT INTO`data_furama`.`contract_detail`(`id`,`quantity`,`contract_id`,`attach_facility_id`)
VALUES(1,5,2,4),
(2,8,2,5),
(3,15,2,6),
(4,1,3,1),
